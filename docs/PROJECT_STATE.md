...
M1-30CH-K is PARTIALLY_SUPPORTED. Before choosing the next intervention, examine the evidence population that stays deep or unresolved under K. Two groups matter: the 2 units still ranked >50 and 1 at 21–50, and the 8 units that F had in Top-10 but K pushed to ranks 11–29. The purpose is to decide whether the remaining problem is Top-10 ordering, which K's much better Top-20/30 curve would favor, or relevance that is still missing. Structured or graph memory is not justified by this result.
